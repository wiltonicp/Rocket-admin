...
public abstract class SortUtil {
    ...
    public static void handlePageSort(QueryRequest request, Page<?> page, String defaultSort, String defaultOrder, boolean camelToUnderscore) {
        ...
        if (camelToUnderscore) {
            sortField = RocketUtil.camelToUnderscore(sortField);
            defaultSort = RocketUtil.camelToUnderscore(defaultSort);
        }
        if (StringUtils.isNotBlank(request.getField())
            ...
            if (StringUtils.equals(request.getOrder(), RocketConstant.ORDER_DESC)) {
            ...
            if (StringUtils.isNotBlank(defaultSort)) {
                if (StringUtils.equals(defaultOrder, RocketConstant.ORDER_DESC)) {
