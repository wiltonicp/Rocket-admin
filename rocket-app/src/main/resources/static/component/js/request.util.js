...
var RequestUtil = (function () {
    ...
    /*GET*/
    requestUtil.sendGet = function(url, params, ft){
        this.sendAJAX(url, params, ft, "GET")
    }

    /*POST*/
    requestUtil.sendPost = function(url, params, ft){
        this.sendAJAX(url, JSON.stringify(params), ft, "POST")
    }
    /*PUT*/
    requestUtil.sendPut = function(url, params, ft){
        this.sendAJAX(url, JSON.stringify(params), ft, "PUT")
    }
    /*DELETE*/
    requestUtil.sendDelete = function(url, params, ft){
    ...
    /*存入本地缓存*/
    requestUtil.setData = function(key, value){
    ...
    /*从本地缓存拿数据*/
    requestUtil.getData = function(key){
        var localData = layui.data('LocalData');
        return localData[key];
    };

    //判断字符是否为空的方法
    requestUtil.isEmpty = function(obj){
    ...
    //字典数据回显
    requestUtil.selectDictLabel = function (datas, value) {
